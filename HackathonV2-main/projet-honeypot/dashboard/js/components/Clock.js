/**
 * Composant Clock
 * Affiche l'horloge temps réel avec timezone correct pour la France
 */
...
export class Clock {
    ...
    render() {
        ...
        this.container.innerHTML = `
            <div class="clock-widget">
                <div class="clock-main">
                    ...
                    <div class="clock-timezone">Paris (UTC${offset})</div>
                </div>
        ...
        this.elements.timezone = this.container.querySelector('.clock-timezone');
    }
    ...
    update() {
        ...
        // Mettre à jour le timezone si changement été/hiver
        if (this.elements.timezone) {
            const offset = TimezoneUtils.getTimezoneOffset();
            this.elements.timezone.textContent = `Paris (UTC${offset})`;
        }
    }
